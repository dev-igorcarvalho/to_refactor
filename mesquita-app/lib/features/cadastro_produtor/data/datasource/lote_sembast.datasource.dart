...
class LoteSembastDatasource extends GenericSembastSource<LoteEntity>
    implements SnapshotFetcher {
  ///BOILERPLATE

  // Nome da STORE/(tabela)
  static const String STORE_NAME = 'lote_store';

  //instancia da STORE
  static final StoreRef<int, Map<String, dynamic>> entityStore =
      intMapStoreFactory.store(STORE_NAME);

  LoteSembastDatasource() : super(entityStore);

  @override
  Future<List<LoteEntity>> fetchAll(
    ...
    final result = snapshots.map((snapshot) {
      final entity = LoteEntity.fromJsonMap(snapshot.value);

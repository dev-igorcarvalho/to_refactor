...
class TipoVacinaSembastDatasource extends GenericSembastSource<TipoVacinaEntity>
    implements SnapshotFetcher {
  ///BOILERPLATE

  // Nome da STORE/(tabela)
  static const String STORE_NAME = 'Vacina_store';

  //instancia da STORE
  static final StoreRef<int, Map<String, dynamic>> entityStore =
      intMapStoreFactory.store(STORE_NAME);

  TipoVacinaSembastDatasource() : super(entityStore);

  @override
  Future<List<TipoVacinaEntity>> fetchAll(
    ...
    final result = snapshots.map((snapshot) {
      final entity = TipoVacinaEntity.fromJsonMap(snapshot.value);

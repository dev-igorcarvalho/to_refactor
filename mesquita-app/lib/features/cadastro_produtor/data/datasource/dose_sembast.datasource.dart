...
class DoseSembastDatasource extends GenericSembastSource<DoseEntity>
    implements SnapshotFetcher {
  ///BOILERPLATE

  // Nome da STORE/(tabela)
  static const String STORE_NAME = 'dose_store';

  //instancia da STORE
  static final StoreRef<int, Map<String, dynamic>> entityStore =
      intMapStoreFactory.store(STORE_NAME);

  DoseSembastDatasource() : super(entityStore);

  @override
  Future<List<DoseEntity>> fetchAll(
    ...
    final result = snapshots.map((snapshot) {
      final entity = DoseEntity.fromJsonMap(snapshot.value);
